				    ...
				    <div class="container-fluid">
				        <section id="alta" style="display: none">
            				<form id="frmAlta">
								<div class="row">
									<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
										<div class="form-group">
											<label for="idPersona">Nombre del Area:</label>
											<input type="text" id="nombre_area" class="form-control" placeholder="Nombre del Area" required>
										</div>
									</div>
									<hr class="linea">
								</div>
								<div class="row">
									<div class="col-lg-12">
										<button type="button" id="btnLista" class="btn btn-login  btn-flat  pull-left">Lista de Areas</button>
	  ...
	  <div class="modal-dialog modal-md">
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title">Editar Datos Area</h4>
	      </div>
	      <div class="modal-body">
				...
				<div class="row">
					<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
						<div class="form-group">
							<label for="idPersona">Nombre del Area:</label>
							<input type="text" id="nombre_areaE" class="form-control" required>
						</div>
					</div>
					<hr class="linea">
				</div>
