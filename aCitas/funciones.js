...
function combo_pacientes(){
    $.ajax({
        url : 'combo_pacientes.php',
        // data : {'id':id},
        type : 'POST',
        dataType : 'html',
        success : function(respuesta) {
            $("#id_paciente").empty();
            $("#id_paciente").html(respuesta);      
        },
        error : function(xhr, status) {
...
function combo_pacientesE(id_paciente){
    $.ajax({
        url : 'combo_pacientesE.php',
        // data : {'id':id},
        type : 'POST',
        dataType : 'html',
        success : function(respuesta) {
            $("#id_pacienteE").empty();
            $("#id_pacienteE").html(respuesta);  
            $("#id_pacienteE").val(id_paciente);  
            $("#id_pacienteE").select2();   
        },
        error : function(xhr, status) {
            alert('Disculpe, existió un problema');
        },
...
function combo_consultoriosE(id_consultorio){
    $.ajax({
        url : 'combo_consultoriosE.php',
        // data : {'id':id},
        type : 'POST',
        dataType : 'html',
        success : function(respuesta) {
            $("#id_consultorioE").empty();
            $("#id_consultorioE").html(respuesta);      
            $("#id_consultorioE").val(id_consultorio);     
            $("#id_consultorioE").select2(); 
        },
        error : function(xhr, status) {
            alert('Disculpe, existió un problema');
        },
