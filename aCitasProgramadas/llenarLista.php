				                ...
				                <table id="example1" class="table table-responsive table-condensed table-bordered table-striped">
									...
									?>
				                      <tr>
				                        ...
				                        <td>
											<input data-size="small" data-style="android" value="<?php echo "$valor"; ?>" type="checkbox" <?php echo "$checado"; ?>  id="<?php echo "interruptor".$n; ?>"  data-toggle="toggle" data-on="Registrar Llegada" data-off="Activar" data-onstyle="primary" data-offstyle="success" class="interruptor" data-width="200" onchange="status(<?php echo $n; ?>,<?php echo $idCita; ?>);">
				                        </td>
				                      </tr>
				                      <?php
									  $n++;
