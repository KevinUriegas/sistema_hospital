				...
				<form id="frmCambiar">
					<div class="form-row">
						...
						<div class="col-md-12">
							<label for="" class="colorLetra">Contraseña:</label>
					          <div class="form-group has-feedback salto">
					            <input type="password" id="pass"  class="form-control " onkeyup="verificar_pass()" >
					            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
					          </div>
						</div>
						<div class="col-md-12">
							<label for="" class="colorLetra">Verificar Contraseña:</label>
					          <div class="form-group has-feedback salto">
					            <input type="password" id="pass1"  class="form-control " onkeyup="verificar_pass()">
					            <span class="glyphicon glyphicon-lock form-control-feedback"></span>
					          </div>
						</div>
					</div>
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-12">
		              			...
		              			<button type="submit" class="btn btn-login  btn-flat  pull-right" id="btn_actualizar_pass" disabled="disabled">
			              			<i class="fas fa-lock-open"></i>
			              			Actualizar
		              			</button>
	              			</div>
